...
var _user$project$Models$initialModel = function (route) {
	return {images: _krisajenkins$remotedata$RemoteData$Loading, route: route};
};
var _user$project$Models$Model = F2(
	function (a, b) {
		return {images: a, route: b};
	});
var _user$project$Models$Image = F3(
	function (a, b, c) {
		return {name: a, path: b, timestamp: c};
	});
var _user$project$Models$NotFoundRoute = {ctor: 'NotFoundRoute'};
var _user$project$Models$ImageRoute = function (a) {
	return {ctor: 'ImageRoute', _0: a};
};
var _user$project$Models$ImagesRoute = {ctor: 'ImagesRoute'};

var _user$project$Msgs$OnLocationChange = function (a) {
	return {ctor: 'OnLocationChange', _0: a};
};
var _user$project$Msgs$OnFetchImages = function (a) {
	return {ctor: 'OnFetchImages', _0: a};
};
...
var _user$project$Commands$imageDecoder = A3(
	...
	A3(
		...
		A3(
			...
			'name',
			_elm_lang$core$Json_Decode$string,
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Models$Image))));
var _user$project$Commands$imagesDecoder = _elm_lang$core$Json_Decode$list(_user$project$Commands$imageDecoder);
var _user$project$Commands$fetchImagesUrl = 'http://localhost:4000/images';
var _user$project$Commands$fetchImages = A2(
	_elm_lang$core$Platform_Cmd$map,
	_user$project$Msgs$OnFetchImages,
	_krisajenkins$remotedata$RemoteData$sendRequest(
		A2(_elm_lang$http$Http$get, _user$project$Commands$fetchImagesUrl, _user$project$Commands$imagesDecoder)));

var _user$project$Images_List$imageRow = function (image) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(image.path),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(image.name),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: _elm_lang$html$Html$text(
								_elm_lang$core$Basics$toString(image.timestamp)),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$src(image.path),
										_1: {ctor: '[]'}
									},
									{ctor: '[]'}),
								_1: {ctor: '[]'}
...
var _user$project$Images_List$list = function (images) {
	return A2(
				...
				{ctor: '[]'},
				{
							...
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Path'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
					...
					_1: {
						...
						_0: A2(
							...
							{ctor: '[]'},
							A2(_elm_lang$core$List$map, _user$project$Images_List$imageRow, images)),
						_1: {ctor: '[]'}
					}
				}),
			_1: {ctor: '[]'}
...
var _user$project$Images_List$maybeList = function (response) {
	var _p0 = response;
	switch (_p0.ctor) {
		case 'NotAsked':
		...
		case 'Success':
			return _user$project$Images_List$list(_p0._0);
		default:
			return _elm_lang$html$Html$text(
				_elm_lang$core$Basics$toString(_p0._0));
	}
};
var _user$project$Images_List$nav = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
...
var _user$project$Images_List$view = function (response) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _user$project$Images_List$nav,
			_1: {
				ctor: '::',
				_0: _user$project$Images_List$maybeList(response),
				_1: {ctor: '[]'}
			}
		});
};
...
var _user$project$Routing$imagePath = function (id) {
	return A2(_elm_lang$core$Basics_ops['++'], '#images/', id);
};
var _user$project$Routing$imagesPath = '#images';
var _user$project$Routing$matchers = _evancz$url_parser$UrlParser$oneOf(
	{
		ctor: '::',
		_0: A2(_evancz$url_parser$UrlParser$map, _user$project$Models$ImagesRoute, _evancz$url_parser$UrlParser$top),
		_1: {ctor: '[]'}
	});
...
var _user$project$View$page = function (model) {
	...
	switch (_p0.ctor) {
		case 'ImagesRoute':
			return _user$project$Images_List$view(model.images);
		case 'NotFoundRoute':
...
var _user$project$Main$init = function (location) {
	...
	return {
		...
		_1: _user$project$Commands$fetchImages
	};
};
